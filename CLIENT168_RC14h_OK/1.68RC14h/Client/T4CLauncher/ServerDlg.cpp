	...
	: CDialog(CServerDlg::IDD, pParent)
{
	...
	m_dwCBLanguage = 0;
	m_bRes640 = FALSE;
	m_bLauncherMusic = FALSE; // steph FALSE au lieu de TRUE
	//}}AFX_DATA_INIT
...
BOOL CServerDlg::OnInitDialog() 
{
   ...
   m_btnFremer.SetFontName("T4C BeaulieuxV2"); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
   ...
   m_btnClose.SetFontName("T4C BeaulieuxV2"); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
   ...
   m_btnAddInf.SetFontName("T4C BeaulieuxV2"); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
   ...
   m_btnDelete.SetFontName("T4C BeaulieuxV2"); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
   ...
   m_btnMacro.SetFontName("T4C BeaulieuxV2"); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
...
void CServerDlg::OnBtnAdd() 
{
   ...
   {
      MessageBox("Label, IP, Username or Password are empty.","Error!",MB_OK+MB_ICONSTOP);
      return;
   }
...
void CServerDlg::OnBtnDel() 
{
   ...
   if(dwSelTmp == -1)
   {
      MessageBox("No label selected.","Error!",MB_OK+MB_ICONSTOP);
      return;
   }
...
void CServerDlg::UpdateServerListIP()
{
   ...
   CString strFile;
   strFile.Format("%s\\iplist.txt",m_strPathGame); // steph ip au lieu de server
