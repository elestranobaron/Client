...
static HSTREAM   g_shChan[2];	// the streams */ // steph désactivation
...
void CMainDialog::DoDataExchange(CDataExchange* pDX)
{
	...
	//DDX_Control(pDX, IDC_STR_WEB_LINK, m_staticLinkWeb); // steph désactivation
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	DDX_Control(pDX, IDC_BTN_LINK1, m_btnLink1);
	DDX_Control(pDX, IDC_BTN_LINK2, m_btnLink2);
	DDX_Control(pDX, IDC_BTN_LINK3, m_btnLink3);
	DDX_Control(pDX, IDC_BTN_LINK4, m_btnLink4);
...
BEGIN_MESSAGE_MAP(CMainDialog, CDialog)
   ...
   ON_WM_LBUTTONDOWN()
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	ON_BN_CLICKED(IDC_BTN_LINK1, OnBtnLink1)
	ON_BN_CLICKED(IDC_BTN_LINK2, OnBtnLink2)
	ON_BN_CLICKED(IDC_BTN_LINK3, OnBtnLink3)
	ON_BN_CLICKED(IDC_BTN_LINK4, OnBtnLink4)
...
BOOL CMainDialog::OnInitDialog() 
{
	...
	m_Language.Create(m_sLauncherConfig.dwLanguage); // steph ajout

   m_strDirectLogin.Format("%s",m_strNMAccountName);
   m_strDirectIP   .Format(m_Language[231],m_strNMAccountIP); // steph m_Language[231] au lieu de "%s"
   ...
   m_btnIntro.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   ...
   // steph ajout
   //////////////////////////////////////////////////////////////////////////////////////////
   m_btnLink1.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   m_btnLink1.SetFont3D(TRUE, CSkinButton::Type3D::Sunken);
   m_btnLink1.SetFontSize(12);
   m_btnLink1.SetFontBold(TRUE);
   m_btnLink1.SetForeColor(RGB(0, 0, 0));

   m_btnLink2.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   m_btnLink2.SetFont3D(TRUE, CSkinButton::Type3D::Sunken);
   m_btnLink2.SetFontSize(12);
   m_btnLink2.SetFontBold(TRUE);
   m_btnLink2.SetForeColor(RGB(0, 0, 0));

   m_btnLink3.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   m_btnLink3.SetFont3D(TRUE, CSkinButton::Type3D::Sunken);
   m_btnLink3.SetFontSize(12);
   m_btnLink3.SetFontBold(TRUE);
   m_btnLink3.SetForeColor(RGB(0, 0, 0));

   m_btnLink4.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   m_btnLink4.SetFont3D(TRUE, CSkinButton::Type3D::Sunken);
   m_btnLink4.SetFontSize(12);
   m_btnLink4.SetFontBold(TRUE);
   m_btnLink4.SetForeColor(RGB(0, 0, 0));
   ...
   m_btnServer.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   ...
   m_btnCredit.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   ...
   m_btnConnect.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   ...
   m_btnQuitter.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   ...
   m_btnMinimize.SetFontName("T4C BeaulieuxV2"); // steph T4C Beaulieux au lieu de T4C BeaulieuxV2
   ...
   /* m_staticLinkWeb.SetFontBold(TRUE);
   m_staticLinkWeb.SetFontName("Arial");
   ...
   LoadAndPlayMusic(); */ // steph désactivation
   

   m_btnIntro.SetText(m_Language[138]); // steph 138 au lieu de 151
   ...
   // steph ajout
   //////////////////////////////////////////////////////////////////////////////////////////
   m_btnLink1.SetText(m_Language[227]);
   m_btnLink2.SetText(m_Language[228]);
   m_btnLink3.SetText(m_Language[229]);
   m_btnLink4.SetText(m_Language[230]);
  ...
  //200,185,120
   ...
   m_dcBitmap.CreateCompatibleDC(NULL);
	...
	m_ctrlCredit.m_dwBackgroundPaintLParam = FALSE; // steph FALSE au lieu de TRUE
...
void CMainDialog::freeDialog()
{
    ...
    m_pNMShowAVI = NULL; */ // steph désactivation
...
{
   //CheckIfNeedToStartStopSound(); // steph désactivation
         ...
         if (msg.message == WM_KEYDOWN)
         {
            ...
            else if(msg.wParam ==VK_UP)
            {
               ...
               else
               {
                  ...
                  GetDlgItem(IDC_BMP_BACK_IP   )->ShowWindow(SW_HIDE); */ // steph désactivation
...
BOOL CMainDialog::LoadSetSkin()
{
   ...
   //m_btnLienWeb.SetDefaultCursor();
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	m_btnLink1.SetBitmap(&m_bmpBtnFrame3);
	m_btnLink2.SetBitmap(&m_bmpBtnFrame3);
	m_btnLink3.SetBitmap(&m_bmpBtnFrame3);
	m_btnLink4.SetBitmap(&m_bmpBtnFrame3);
...
{
	ShellExecute(0,0,"https://t4c-rebirth.com/",0,0,1); // steph ajout
   if(m_bIntroStatus)
   {
      /* m_bIntroStatus = FALSE;
      m_pNMShowAVI->CloseInterfaces();
      ...
      GetDlgItem(IDC_BTN_SERVER_INFO)->EnableWindow(TRUE);
      GetDlgItem(IDC_BTN_CREDIT     )->EnableWindow(TRUE);
      ChangeConnectStat(TRUE); */ // steph désactivation
   }
   else
   {
      /* SetTimer(TIMER_INTRO_FIRST_PLAY,300,0);
      ...
      GetDlgItem(IDC_MSTATIC_PASSWORD)->ShowWindow(SW_HIDE);
	  GetDlgItem(IDC_BMP_BACK_IP   )->ShowWindow(SW_HIDE);
      GetDlgItem(IDC_BMP_BACK_INTRO)->ShowWindow(SW_SHOW); */ // steph désactivation
   }
...
// steph ajout
//////////////////////////////////////////////////////////////////////////////////////////
void CMainDialog::OnBtnLink1()
{
	ShellExecute(0, 0, "https://t4c-rebirth.com/foire-aux-questions.php", 0, 0, 1);
}
...
{
	ShellExecute(0, 0, "https://t4c-rebirth.com/modules/login.php", 0, 0, 1);
}
...
void CMainDialog::OnBtnCredit() 
{
	if(m_bCreditStatus)
   {
	  ...
	  // steph ajout
	  //////////////////////////////////////////////////////////////////////////////////////////
	  GetDlgItem(IDC_BTN_LINK1)->EnableWindow(TRUE);
	  GetDlgItem(IDC_BTN_LINK2)->EnableWindow(TRUE);
	  GetDlgItem(IDC_BTN_LINK3)->EnableWindow(TRUE);
	  GetDlgItem(IDC_BTN_LINK4)->EnableWindow(TRUE);
...
void CMainDialog::OnTimer(UINT nIDEvent) 
{
	switch(nIDEvent)
   {
      case TIMER_INTRO_FIRST_PLAY:
      {
         ...
         //m_pDropServer         .ShowWindow(SW_HIDE);
         //m_btnConnect          .ShowWindow(SW_HIDE);
         //m_pNMShowAVI->PlayVideoFile(m_strIntroDls.GetBuffer(0)); // steph désactivation
         //GetDlgItem(IDC_BMP_BACK_INTRO)->ShowWindow(SW_SHOW);
      ...
      case TIMER_CREDIT_FIRST_PLAY:
      {
		 ...
		 // steph ajout
		 //////////////////////////////////////////////////////////////////////////////////////////
		 GetDlgItem(IDC_BTN_LINK1)->EnableWindow(FALSE);
		 GetDlgItem(IDC_BTN_LINK2)->EnableWindow(FALSE);
		 GetDlgItem(IDC_BTN_LINK3)->EnableWindow(FALSE);
		 GetDlgItem(IDC_BTN_LINK4)->EnableWindow(FALSE);
...
void CMainDialog::WriteConfig()
{
   ...
   if(pf1)
   {
      ...
      for(int i=0;i<m_sLauncherConfig.dwNbrConnection;i++) // DaP ajout de int
      {
...
int  CMainDialog::GetWidth()
{
   if(m_sLauncherConfig.bResolution == 0)
      ...
      return 1024; // steph 1024 au lieu de 800
   else
      return 1280; // steph 1280 au lieu de 1024
...
int  CMainDialog::GetHeight()
{
   if(m_sLauncherConfig.bResolution == 0)
      ...
      return 720; // steph 720 au lieu de 768
   else if(m_sLauncherConfig.bResolution == 2)
      return 768; // steph 768 au lieu de 600
   else
      return 800; // steph 800 au lieu de 768
}
