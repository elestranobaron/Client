...
// Global var.
GUIDELocalString g_GUIDELocalString;

//*********************************************************************************
GUIDELocalString::GUIDELocalString(void)
/**********************************************************************************
* Constructor
*/
{
...
//*********************************************************************************
void GUIDELocalString::Create(int dwLanguage)
/**********************************************************************************
...
//*********************************************************************************
void GUIDELocalString::Release(void)
/**********************************************************************************
...
//*********************************************************************************
char *GUIDELocalString::operator []
/**********************************************************************************
...
//*********************************************************************************
void GUIDELocalString::LoadAllStrings(int dwLanguage)
/**********************************************************************************
...
*/
{
	...
	if (dwLanguage == 0)
		sprintf(lngFile, "EnglishGUIDE.elng");
	else if (dwLanguage == 1)
		sprintf(lngFile, "FrenchGUIDE.elng");
	else
		sprintf(lngFile, "EnglishGUIDE.elng");
	...
	if (f == NULL)
		f = fopen("EnglishGUIDE.elng", "rb");
	if (f == NULL)
	{
		LanguageString[0] = new char[40];
		strcpy(LanguageString[0], "Cannot open language file: EnglishGUIDE.elng");
		dwStringNb = 1;
		return;
	}
...
//*********************************************************************************
char GUIDELocalString::GetHotKey
/**********************************************************************************
...
void GUIDELocalString::CannotParse(void) {
	Release();
