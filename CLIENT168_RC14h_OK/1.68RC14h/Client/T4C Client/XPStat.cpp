...
void XpStat::CalculateAndShowXpStat(__int64 pXpNow, __int64 pExp2Go){
	try{
		...
		char texte1[200];
		// asteryth modified "Started at" by "Calculation time" and hour1, min1 and sec1 by mine
		...
		// asteryth modification of xp written
		...
		char texte2[200];
		// asteryth modified {%0.2f xp/h}. ", speed_moy); by  {%s xp/h}.",buffer);
