...
void FontManager::Initialize(void) {
    ...
    CreateFont( "T4C BeaulieuxV2", &lpFont[2], 22 ); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
    CreateFont( "Verdana"      , &lpFont[3], 18); 
    CreateFont( "T4C BeaulieuxV2", &lpFont[4], 26 ); // steph T4C BeaulieuxV2 au lieu de T4C Beaulieux
...
void TextObject::Redo(void) {
    ...
    if (m_MaxWidth != 0) {
        ...
        const int BorderOutlineWidth = 2; // DaP ajout de int
        if( m_Outline ){
