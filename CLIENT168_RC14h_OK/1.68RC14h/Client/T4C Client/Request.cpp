...
bool Request::SendRequest(bool IsPost, LPCSTR url, char *psHeaderSend, char *psHeaderReceive, char *psMessage)
{
   HTTPRequest			req;
   int					i,rtn;
   LPSTR				buffer;
   ...
   {
      strcpy(psHeaderSend    ,req.headerSend);
      strcpy(psHeaderReceive ,req.headerReceive);
      strcpy(psMessage		  ,req.message);
