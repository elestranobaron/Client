...
CSaveGame::CSaveGame()
{
   ...
   //////////////////////////////////////////////////////////////////////////////////////////
   // steph 5 au lieu de 9
   //////////////////////////////////////////////////////////////////////////////////////////
   m_pOptionParams.dwMusicVol              = 5;
   m_pOptionParams.dwSoundVol              = 5;
   ...
   // steph ajout
   //////////////////////////////////////////////////////////////////////////////////////////
   m_pOptionParams.bEnableDisplayGold = 1;
   m_pOptionParams.bEnable32FPS = 1;
...
*/
	  ...
	  if(strcmp(chHeader,"BL_V2SAVEGAME_V004") == 0)
      {
         ...
         if (dwNbrInv) for(int i=0;i<dwNbrInv;i++) // DaP ajout de int
         {
         ...
         if (dwNbrMacroItem) for(int i=0;i<dwNbrMacroItem;i++) // DaP ajout de int
         {
         ...
         if (dwNbrMacroSpell) for(int i=0;i<dwNbrMacroSpell;i++) // DaP ajout de int
         {
            //memcpy(&pMacro,pchBuff,sizeof(sMacro)); pchBuff+=sizeof(sMacro);
			fread(&pMacro, sizeof(sMacro),1,pf);
         ...
         if (dwNbrMacroSkill) for(int i=0;i<dwNbrMacroSkill;i++) // DaP ajout de int
         {
            //memcpy(&pMacro,pchBuff,sizeof(sMacro)); pchBuff+=sizeof(sMacro);
			fread(&pMacro, sizeof(sMacro),1,pf);
         ...
         if (dwNbrChannel) for(int i=0;i<dwNbrChannel;i++) // DaP ajout de int
         {
         ...
         if (dwNbrIgnore) for(int i=0;i<dwNbrIgnore;i++) // DaP ajout de int
         {
         ...
         if (dwNbrChest) for(int i=0;i<dwNbrChest;i++) // DaP ajout de int
         {
            //memcpy(&pInventory,pchBuff,sizeof(sInventory)); pchBuff+=sizeof(sInventory);
   		    fread(&pInventory, sizeof(sInventory),1,pf);
            AddChest(pInventory);
