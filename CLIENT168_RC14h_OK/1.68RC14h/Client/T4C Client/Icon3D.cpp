...
//   CorpseShd = new CV2Sprite[faces5];
   ...
   // New pallet loading system
	...
	if (CV2PalManager::GetInstance()->m_plRefPal.GetPalette() == nullptr) // DaP ajout
		CV2PalManager::GetInstance()->m_plRefPal.LoadPalette("Bright1");  // DaP ajout
...
/*   for (i = 0; i < faces5; i++) {
   ...
   if (CV2PalManager::GetInstance()->m_plRefPal.GetPalette() == nullptr) // DaP ajout
	...
	int iB000 = 0, iB045 = 0, iB090 = 0, iB135 = 0, iB180 = 0;
   for (int i = 0; i < faces; i++) { // DaP ajout de int
		strcpy(ID, ViewID);
		strcat(ID, "000-");
		Temp2[0] = (i*FRAMING) + 'a';
		strcat(ID, Temp2);
   ...
   for (int i = 0; i < faces2; i++) { // DaP ajout de int
		strcpy(ID, ViewID);
      if (Type != 3)
         strcat(ID, "A");
		strcat(ID, "000-");
   ...
   iB000 = 0; iB045 = 0; iB090 = 0; iB135 = 0; iB180 = 0;
   for (int i = 0; i < faces3; i++) { // DaP ajout de int
		strcpy(ID, ViewID);
		strcat(ID, "StAtt000-");
		Temp2[0] = (i*FRAMING) + 'a';
		strcat(ID, Temp2);
	...
	iB000 = 0; iB045 = 0; iB090 = 0; iB135 = 0; iB180 = 0;
   for (int i = 0; i < faces4; i++) { // DaP ajout de int
		strcpy(ID, ViewID);
		strcat(ID, "StMov000-");
		Temp2[0] = (i*FRAMING) + 'a';
		strcat(ID, Temp2);
...
/*   for (i = 0; i < faces5; i++) {
   ...
   for (int i = 0; i < faces2; i++) { // DaP ajout de int
	...
	iB000 = 0; iB045 = 0; iB090 = 0; iB135 = 0; iB180 = 0;
   for (int i = 0; i < faces6; i++) { // DaP ajout de int
		strcpy(ID, ViewID);
      if (Type != 3)
         strcat(ID, "B");
		strcat(ID, "000-");
