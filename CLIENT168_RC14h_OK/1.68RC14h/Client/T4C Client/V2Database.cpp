...
//////////////////////////////////////////////////////////////////////////////////////////
#define V2DATABASE_INDEX  "gamefiles\\V2DataI.did"
#define V2DATABASE_DATA   "gamefiles\\V2Data" //need to add index and .dda
...
void  CV2Database::LoadIndex()
{
	...
	for (int i = 0; i < NB_FILES; i++) // DaP ajout de int
	{
