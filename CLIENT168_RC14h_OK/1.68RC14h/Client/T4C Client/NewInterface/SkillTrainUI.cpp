...
namespace{
    ...
    const int SkillNameSize = 171; // DaP ajout de int
};

// Constructor //////////////////////////////////////////////////////////////////////////
SkillTrainUI::SkillTrainUI( void ) :
...
void SkillTrainUI::Draw(V2SPRITEFX *vsfFX)
{
   int dwXPos = (g_Global.GetScreenW()-576)/2;
   int dwYPos = (g_Global.GetScreenH()-150-368)/2;
   if(dwYPos <0)
   ...
   // Draw les texte...
   char strBtnTexte[20];
   sprintf(strBtnTexte  ,"%s",g_GUILocalString[81]);
...
int SkillTrainUI::TxtOff(Font *pFont, HDC hdc, char *pStr,int dwBoxZise)
{
...
//////////////////////////////////////////////////////////////////////////////////////////
SkillTrainUI *SkillTrainUI::GetInstance( void )
//////////////////////////////////////////////////////////////////////////////////////////
// Returns the only sell UI instance.
//////////////////////////////////////////////////////////////////////////////////////////
{
    static SkillTrainUI instance;
    return &instance;
}

//////////////////////////////////////////////////////////////////////////////////////////
void SkillTrainUI::Train
//////////////////////////////////////////////////////////////////////////////////////////
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( sellItemList.size() != 0 ){
        ...
        for( i = sellItemList.begin(); i != sellItemList.end(); i++ ){
            ...
            // The current qty.
            newTextItem = new StaticTextUI;
            newTextItem->SetText( itoa( (*i).qty, buf, 10 ), textColor );
            newTextItem->SetPos( FramePos( 0, 0, newTextItem->GetWidth(), newTextItem->GetHeight() ) );
            newTextItem->SetCenter( false );
...
//////////////////////////////////////////////////////////////////////////////////////////
void SkillTrainUI::SellButtonEvent::LeftClicked( void )
//////////////////////////////////////////////////////////////////////////////////////////
//  Player wants to sell the items it has selected.
// 
//////////////////////////////////////////////////////////////////////////////////////////
{
    SkillTrainUI *sellUI = static_cast< SkillTrainUI * >( GetUI() );
    ...
    for( i = (*items)[0].begin(); i != (*items)[0].end(); i++ ){
        ...
        LOG.Lock();
        LOG << "\r\nFound sell item " << (char *)sellItem->itemInfo.name.c_str() << " qty= " << sellItem->itemInfo.qty << "  ";
        LOG.Unlock();
...
//////////////////////////////////////////////////////////////////////////////////////////
void SkillTrainUI::ItemListEvent::LeftClicked( void )
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    if( col == 4 ){        
        ...
        if( selection != NULL ){
            ...
            if( MouseDevice::yPos < 
                ...
                if( item->itemInfo.canHave && item->itemInfo.qty < item->itemInfo.maxQty &&
                    sellUI->skillPnts > 0 ){
                    ...
                    if( currentPrice + item->itemInfo.price <= Player.Gold ){
                        ...
                        sellUI->skillDisp.SetText( itoa( sellUI->skillPnts, buf, 10 ) );
...
//////////////////////////////////////////////////////////////////////////////////////////
void SkillTrainUI::ItemListEvent::LeftDblClicked( void )
//////////////////////////////////////////////////////////////////////////////////////////
