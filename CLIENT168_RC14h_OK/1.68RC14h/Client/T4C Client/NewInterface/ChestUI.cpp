   ...
   X_Button( hideEvent )
{
   ...
   backChestT.SetPos( FramePos( dwXPos, dwYPos, dwXPos+552, dwYPos+260 ) ); // steph 552 au lieu de 550
   backChestT.DrawAlpha(true);
    
   backChestB.SetSpriteId( "GUI_InvBackB" );
   backChestB.SetPos( FramePos( dwXPos, dwYPos+260, dwXPos+552, dwYPos+430 ) ); // steph 552 au lieu de 550
