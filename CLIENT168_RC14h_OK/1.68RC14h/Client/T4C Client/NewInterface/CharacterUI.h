...
private:
	...
	StaticTextUI kill;
	StaticTextUI death;
	StaticTextUI resistAir;
	StaticTextUI resistWater;
	StaticTextUI resistFire;
	StaticTextUI resistEarth;
	StaticTextUI resistDark;
	StaticTextUI resistLight;
	StaticTextUI powerAir;
	StaticTextUI powerWater;
	StaticTextUI powerFire;
	StaticTextUI powerEarth;
	StaticTextUI powerDark;
	StaticTextUI powerLight;
