...
SideMenu::SideMenu()
{
   ...
   sprintf(m_TMIFile,"%s%s",strPath,"\\gamefiles\\TMI_Map.dat"); // steph gamefiles au lieu de Game Files
...
void SideMenu::SetupViewObject()
{
   ...
   //Armor and items...
   for(int i=1;i<=14;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=18;i<=103;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=107;i<=129;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=141;i<=142;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=163;i<=189;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=200;i<=213;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=235;i<=289;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=294;i<=329;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;

   for(int i=421;i<=455;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=458;i<=644;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=646;i<=768;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=782;i<=790;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
   for(int i=869;i<=872;i++) // DaP ajout de int
      m_bShowThisObjType[i] = TRUE;
