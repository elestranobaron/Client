...
:    
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	iconKill(EmptyEvent::GetInstance()),
	iconDeath(EmptyEvent::GetInstance()),
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    int dwXPos = (g_Global.GetScreenW()-700)/2; // steph 700 au lieu de 576
    int dwYPos = (g_Global.GetScreenH()-150-408)/2; // steph 408 au lieu de 368
    if(dwYPos <0)
       dwYPos =0;
    
    SetPos( FramePos( dwXPos, dwYPos, dwXPos+700, dwYPos+408 ) ); // steph 408 au lieu de 368 et 700 au lieu de 576
    SetHelpId( this, 297 );
    
    backStat.SetSpriteId( "GUI_BackStat" );
    backStat.SetPos( FramePos( dwXPos, dwYPos, dwXPos+700, dwYPos+408 ) ); // steph 408 au lieu de 368 et 700 au lieu de 576
    backStat.DrawAlpha(true);

    X_Button.SetPos        ( FramePos( dwXPos+700-28, dwYPos+0, dwXPos+700-4, dwYPos+0+24 ) ); // steph 700 au lieu de 576
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	kill.SetPos(FramePos(dwXPos + 52, dwYPos + 275, dwXPos + 139, dwYPos + 289));
	death.SetPos(FramePos(dwXPos + 203, dwYPos + 275, dwXPos + 290, dwYPos + 289));
	resistAir.SetPos(FramePos(dwXPos + 559, dwYPos + 80, dwXPos + 646, dwYPos + 94));
	resistWater.SetPos(FramePos(dwXPos + 559, dwYPos + 134, dwXPos + 646, dwYPos + 148));
	resistFire.SetPos(FramePos(dwXPos + 559, dwYPos + 188, dwXPos + 646, dwYPos + 202));
	resistEarth.SetPos(FramePos(dwXPos + 559, dwYPos + 242, dwXPos + 646, dwYPos + 256));
	resistDark.SetPos(FramePos(dwXPos + 559, dwYPos + 296, dwXPos + 646, dwYPos + 310));
	resistLight.SetPos(FramePos(dwXPos + 559, dwYPos + 350, dwXPos + 646, dwYPos + 364));
	powerAir.SetPos(FramePos(dwXPos + 623, dwYPos + 80, dwXPos + 710, dwYPos + 94));
	powerWater.SetPos(FramePos(dwXPos + 623, dwYPos + 134, dwXPos + 710, dwYPos + 148));
	powerFire.SetPos(FramePos(dwXPos + 623, dwYPos + 188, dwXPos + 710, dwYPos + 202));
	powerEarth.SetPos(FramePos(dwXPos + 623, dwYPos + 242, dwXPos + 710, dwYPos + 256));
	powerDark.SetPos(FramePos(dwXPos + 623, dwYPos + 296, dwXPos + 710, dwYPos + 310));
	powerLight.SetPos(FramePos(dwXPos + 623, dwYPos + 350, dwXPos + 710, dwYPos + 364));
    ...
    statXP.SetPos   ( FramePos( dwXPos+39, dwYPos+342 , dwXPos+210, dwYPos+353 ) ); // steph 342 au lieu de 301 et 353 au lieu de 312
    SetHelpId( statXP, 292 );

    statXP2GO.SetPos( FramePos( dwXPos+233, dwYPos+342 , dwXPos+404, dwYPos+353 ) ); // steph 342 au lieu de 301 et 353 au lieu de 312
    SetHelpId( statXP2GO, 293 );

    karma.SetPos    ( FramePos( dwXPos+426, dwYPos+342 , dwXPos+535, dwYPos+353 ) ); // steph 342 au lieu de 301 et 353 au lieu de 312
    SetHelpId( karma, 294 );
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	kill.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	death.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	resistAir.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	resistWater.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	resistFire.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	resistEarth.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	resistDark.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	resistLight.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	powerAir.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	powerWater.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	powerFire.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	powerEarth.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	powerDark.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	powerLight.SetHelpText(FontManager::GetInstance()->GetSmallFont(FALSE));
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	iconKill.SetPos(FramePos(dwXPos + 15, dwYPos + 268, dwXPos + 58, dwYPos + 297));
	iconDeath.SetPos(FramePos(dwXPos + 167, dwYPos + 268, dwXPos + 196, dwYPos + 297));
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	iconKill.EnableSound(false);
	iconDeath.EnableSound(false);
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	SetHelpId(iconKill, 602);
	SetHelpId(iconDeath, 603);
    ...
    macroButton.SetPos ( FramePos( dwXPos+700-35-60, dwYPos+1, dwXPos+700-35, dwYPos+1+22 ) ); // steph 700 au lieu de 576
	...
	AddChild(&death);
	AddChild(&resistAir);
	AddChild(&resistWater);
	AddChild(&resistFire);
	AddChild(&resistEarth);
	AddChild(&resistDark);
	AddChild(&resistLight);
	AddChild(&powerAir);
	AddChild(&powerWater);
	AddChild(&powerFire);
	AddChild(&powerEarth);
...
void CharacterUI::Draw(V2SPRITEFX *vsfFX)
{
   ...
   fNewGuiBtnFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiBtnFont,hdc,strBtnTexte ,101)+ 300+1, dwYPos+0+1 , RGB(0, 0, 0)    , 0, strBtnTexte); // steph 300 au lieu de 237
   fNewGuiBtnFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiBtnFont,hdc,strBtnTexte ,101)+ 300  , dwYPos+0   , g_Global.GetBtnTCE(), 0, strBtnTexte); // steph 300 au lieu de 237
   ...
   fNewGuiFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiFont,hdc,strBtnTexte ,174)+ 38  , dwYPos+321   , g_Global.GetBtnTCE(), 0, strBtnTexte); // steph 321 au lieu de 281
   sprintf(strBtnTexte  ,"%s",g_GUILocalString[21]);
   fNewGuiFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiFont,hdc,strBtnTexte ,174)+ 232  , dwYPos+321   , g_Global.GetBtnTCE(), 0, strBtnTexte); // steph 321 au lieu de 281
   sprintf(strBtnTexte  ,"%s",g_GUILocalString[22]);
   fNewGuiFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiFont,hdc,strBtnTexte ,112)+ 425  , dwYPos+321   , g_Global.GetBtnTCE(), 0, strBtnTexte); // steph 321 au lieu de 281

   sprintf(strBtnTexte  ,"%s",g_GUILocalString[16]);
   fNewGuiBtnFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiBtnFont,hdc,strBtnTexte ,60)+ 700-35-60, dwYPos , RGB(0, 0, 0)    , 0, strBtnTexte); // steph 700 au lieu de 576
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    const int lightValue = 50; // DaP ajout de int
...
//////////////////////////////////////////////////////////////////////////////////////////
{
	...
	//////////////////////////////////////////////////////////////////////////////////////////
	str += " (";
	str += itoa(Player.MaxWeight - Player.Weight, buf, 10);
	str += ")";
	...
	// steph ajout
	//////////////////////////////////////////////////////////////////////////////////////////
	str = itoa(Player.CurrentKillNumber, buf, 10);
	kill.SetText(str.c_str());
	kill.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.CurrentDeathNumber, buf, 10);
	death.SetText(str.c_str());
	death.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Resist.Air, buf, 10);
	resistAir.SetText(str.c_str());
	resistAir.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Resist.Water, buf, 10);
	resistWater.SetText(str.c_str());
	resistWater.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Resist.Fire, buf, 10);
	resistFire.SetText(str.c_str());
	resistFire.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Resist.Earth, buf, 10);
	resistEarth.SetText(str.c_str());
	resistEarth.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Resist.Dark, buf, 10);
	resistDark.SetText(str.c_str());
	resistDark.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Resist.Light, buf, 10);
	resistLight.SetText(str.c_str());
	resistLight.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Power.Air, buf, 10);
	powerAir.SetText(str.c_str());
	powerAir.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Power.Water, buf, 10);
	powerWater.SetText(str.c_str());
	powerWater.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Power.Fire, buf, 10);
	powerFire.SetText(str.c_str());
	powerFire.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Power.Earth, buf, 10);
	powerEarth.SetText(str.c_str());
	powerEarth.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Power.Dark, buf, 10);
	powerDark.SetText(str.c_str());
	powerDark.GetHelpText()->SetText(str.c_str());
	str = itoa(Player.Power.Light, buf, 10);
	powerLight.SetText(str.c_str());
	powerLight.GetHelpText()->SetText(str.c_str());
...
//////////////////////////////////////////////////////////////////////////////////////////
{
	...
	if (g_SaveGame.GetOptionsParam()->bOldStatBar)
	{
		...
		//BLBL tentative d'affichage de l'XP restante même sur la vielle barre d'xp
