...
extern Font *fNewGuiFont; // steph ajout




/* #define V2IMAGEUSENAME_HEADER   "\\Game Files\\UseItemBDI.dat"
#define V2IMAGEUSENAME_DATA     "\\Game Files\\UseItemBDD.dat" */ // steph désactivation
...
InventoryUI::InventoryUI(void)
	...
	ring3DropZone(equipEvent), // steph ajout
...
//////////////////////////////////////////////////////////////////////////////////////////
{
     ...
     int dwXPos = (g_Global.GetScreenW()-552)/2; // steph 552 au lieu de 550
     int dwYPos = (g_Global.GetScreenH()-150-430)/2;
     if(dwYPos <0)
        dwYPos =0;
     
     SetPos( FramePos( dwXPos, dwYPos, dwXPos+552, dwYPos+430 ) ); // steph 552 au lieu de 550
     SetHelpId( this, 285 );
     
     backInvT.SetSpriteId( "GUI_InvBackT" );
     backInvT.SetPos( FramePos( dwXPos, dwYPos, dwXPos+552, dwYPos+260 ) ); // steph 552 au lieu de 550
     backInvT.DrawAlpha(true);

     backInvB.SetSpriteId( "GUI_InvBackB" );
     backInvB.SetPos( FramePos( dwXPos, dwYPos+260, dwXPos+552, dwYPos+430 ) ); // steph 552 au lieu de 550
     backInvB.DrawAlpha(true);
 
     X_Button.SetPos( FramePos( dwXPos+552-28, dwYPos+0, dwXPos+552-4, dwYPos+0+24 ) ); // steph 552 au lieu de 550
     ...
     macroButton.SetPos ( FramePos( dwXPos+552-35-60, dwYPos+1, dwXPos+552-35, dwYPos+1+22 ) ); // steph 552 au lieu de 550
     ...
     mainDropZone  .SetPos(  FramePos( dwXPos+417, dwYPos+72, dwXPos+552, dwYPos+246 ) ); // steph 552 au lieu de 550
	 ...
	 ring3DropZone.SetPos(FramePos(dwXPos + 253, dwYPos + 205, dwXPos + 287, dwYPos + 239)); // steph ajout
	 ...
	 SetHelpId(ring3DropZone, 604); // steph ajout
	 ...
	 AddChild(&ring3DropZone); // steph ajout
     ...
     //ReadDisplayBDImage(); // steph désactivation
...
void InventoryUI::Draw(V2SPRITEFX *vsfFX)
{
   ...
   // Draw les texte...
   char strBtnTexte[20];
   fNewGuiFont->DrawFont(hdc, dwXPos + 424 , dwYPos +54, RGB(255, 255, 255), 0, Player.Name); // steph ajout

   sprintf(strBtnTexte  ,"%s",g_GUILocalString[16]);
   fNewGuiBtnFont->DrawFont(hdc, dwXPos+TxtOff(fNewGuiBtnFont,hdc,strBtnTexte ,60)+ 552-35-60, dwYPos , RGB(0, 0, 0)    , 0, strBtnTexte); // steph 552 au lieu de 550
...
//////////////////////////////////////////////////////////////////////////////////////////
{
   ...
   else 
   {
      ...
      if(bFound)
      {
         ...
         //InventoryUI::GetInstance()->ReadImageFile(InventoryUI::GetInstance()->m_vImageDisplay[iIndex].iOffset,pImage,pPal); // steph désactivation
