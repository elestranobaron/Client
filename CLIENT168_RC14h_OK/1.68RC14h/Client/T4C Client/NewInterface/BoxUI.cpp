...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( foregroundChild == NULL || foregroundChild == this ){
		...
		ChildQueue *rootChildren = this->GetChildList(); // DaP this au lieu de rootBox (rootBox semble empêcher le dernier chargement du jeu)
...
//////////////////////////////////////////////////////////////////////////////////////////
{
    ...
    if( foregroundChild == NULL ){    
        ...
        if( putForeground ){
            //RootBoxUI *rootBox = RootBoxUI::GetInstance(); // DaP désactivation (semble empêcher l'affichage du premier menu)
			ChildQueue *rootChildren = this->GetChildList(); // DaP this au lieu de rootBox (rootBox semble empêcher l'affichage du premier menu)
