...
{  
    ...
    int dwYPos = (g_Global.GetScreenH()-150-365)/2; // steph 365 au lieu de 328
    if(dwYPos <0)
       dwYPos =0;

    SetPos( FramePos( dwXPos , dwYPos, dwXPos+340, dwYPos+365 ) ); // steph 365 au lieu de 328
    SetHelpId( this, 329 );
    
    backImage.SetSpriteId( "GUI_BackGroupBk" );
    backImage.SetPos( FramePos( dwXPos , dwYPos, dwXPos+340, dwYPos+365 ) ); // steph 365 au lieu de 328
    ...
    M_Button.SetPos( FramePos( dwXPos+3, dwYPos+337, dwXPos+3+24, dwYPos+337+24 ) ); // steph 337 au lieu de 300
    ...
    X_Button.SetPos( FramePos( dwXPos+31, dwYPos+337, dwXPos+31+24, dwYPos+337+24 ) ); // steph 337 au lieu de 300
...
void GroupPlayUI::DrawMinimized( V2SPRITEFX *vsfFX )
{
    ...
    const int space = 22; // DaP ajout de int
    int pass = 0;
    UINT i;
    int dwNbrGrp = 0;  
