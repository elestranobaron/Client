   ...
   disabledRobButton( EmptyEvent::GetInstance() )
{
   ...
   SetPos( FramePos( dwXPos, dwYPos, dwXPos+552, dwYPos+199 ) ); // steph 552 au lieu de 550
   SetHelpId( this, 285 );
   
   backInv.SetSpriteId( "GUI_BackRob" );
   backInv.SetPos( FramePos( dwXPos, dwYPos, dwXPos+552, dwYPos+199 ) ); // steph 552 au lieu de 550
