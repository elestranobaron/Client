...
#define V2DATABASE_PALETTE  "gamefiles\\V2ColorI.dpd" // steph gamefiles au lieu de Game Files
...
CV2PalManager::CV2PalManager()
{
   ...
   for(int i=0;i<m_dwNbrPalette;i++) // DaP ajout de int
   {
   ...
   //m_plRefPal.LoadPalette("Bright1"); // DaP désactivation (semble empêcher le lancement du jeu)
