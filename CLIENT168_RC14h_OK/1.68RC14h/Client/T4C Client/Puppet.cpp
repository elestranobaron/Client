...
/*               } else {
   ...
   //##NMNMNM [ Z-Order des partie du player a corriger certain...]
    ...
    // ATTACK
    for (int i = 0; i < 9; i++) { // DaP ajout de int
        // 045
    ...
    for (int i = 2; i < 8; i++) { // DaP ajout de int
        // 090        
        BodyOrderAR[4][ 0][i] = PUP_HAND_RIGHT;
        BodyOrderAR[4][ 1][i] = PUP_ARM_RIGHT;
        BodyOrderAR[4][ 2][i] = PUP_FOOT;
    ...
    for (int i = 8; i < 9; i++) { // DaP ajout de int
        // 090        
        BodyOrderAR[4][ 0][i] = PUP_HAND_RIGHT;
        BodyOrderAR[4][ 1][i] = PUP_ARM_RIGHT;
        BodyOrderAR[4][ 2][i] = PUP_FOOT;
    ...
    // 180
    for (int i = 2; i < 5; i++) { // DaP ajout de int
        BodyOrderAR[8][ 0][i] = PUP_WEAPON2;
        BodyOrderAR[8][ 1][i] = PUP_SHIELD;
    ...
    // 180
    for (int i = 5; i < 9; i++) { // DaP ajout de int
        BodyOrderAR[8][ 0][i] = PUP_WEAPON2;
        BodyOrderAR[8][ 1][i] = PUP_SHIELD;
        BodyOrderAR[8][ 2][i] = PUP_WEAPON;
        BodyOrderAR[8][ 3][i] = PUP_HAND_RIGHT;
    ...
    // 135
    for (int i = 2; i < 9; i++) { // DaP ajout de int
    ...
    // 000
    for (int i = 0; i < 5; i++) { // DaP ajout de int
    ...
    // WALKING
    for (int i = 0; i < 13; i++) { // DaP ajout de int
        // 045
