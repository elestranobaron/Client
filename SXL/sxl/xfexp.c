...
static const float q[] = {	/* courtesy Dr. Tim Prince */
	12.01517514F,
	120.18228722F};
static const double c1 = (double)(22713.0 / 32768.0);
static const double c2 = (double)1.428606820309417232e-6L;
static const float hugexp = (float)FHUGE_EXP;
...
_CRTIMP2 short _FExp(float *px, float y, short eoff)
	...
	if (*px < -hugexp || y == 0)
		...
		*px = _FInf._F;
		...
		{	/* xexp won't overflow */
		float g = *px * invln2;
		short xexp = (short)(g + (g < 0 ? - 0.5F : + 0.5F));
